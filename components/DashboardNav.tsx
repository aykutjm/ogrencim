          ...
          <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
            ...
            {userRole === 'superadmin' && (
              <Link 
                ...
                className="flex items-center gap-1 px-2 py-1.5 sm:px-3 sm:py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-md sm:rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all font-semibold text-xs shadow-md hover:shadow-lg"
              >
                <span>🔐</span>
            ...
            {userRole === 'admin' && (
              <Link 
                ...
                className="flex items-center gap-1 px-2 py-1.5 sm:px-3 sm:py-2 bg-gradient-to-r from-green-600 to-teal-600 text-white rounded-md sm:rounded-lg hover:from-green-700 hover:to-teal-700 transition-all font-semibold text-xs shadow-md hover:shadow-lg"
              >
                <span>🏫</span>
                <span className="hidden sm:inline">İdareci Paneli</span>
              </Link>
            )}
